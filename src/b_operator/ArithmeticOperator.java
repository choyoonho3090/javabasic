...
public class ArithmeticOperator {
	...
	public static void main(String[] args) {
		 ...
		 * - / : 나누기
		 * - % : 나머지
		 * - 이항 연산자는 양쪽의 피연사자의 타입이 일치해야 연산이 가능하다.
		*/
		
		int a = 10 + 20 - 10 * 5 / 10 % 2;
		//수학과 같이 *, /, % 연산자가 +, - 보다 연산의 운선순위가 높다.
		//우선순위가 동등할 경우 왼쪽부터 연산이 수행된다.
		System.out.println(a);
		
		a = (int) (10 + 20.3); //int + double -> double + double
		//피연산자의 타입이 서로 다를 경우 표현 범위가 큰 쪽으로 형변환 후 연산이 수행된다.
		...
		System.out.println(e1); //overflow가 발생
		long e2 = 100000 * 100000L;
		//피연사자 중 하나는 long이어야 결과로 long을 얻을 수 있다.
		...
		//int g1 = 10 / 0; //정수는 0으로 나눌 수 없다 //런타임 에러 발생
		float g2 = 10.0f / 0; //실수는 0으로 나눌 수 있다.		
		...
		//문제2. 3개의 int형 변수를 선언 및 초기화 후 합계와 평균을 구해주세요.(평균은 소수점 둘째자리에서 반올림)
		int x = 3;
		int y = 4;
		int z = 7;
		int w = x + y + z;
		...
		System.out.println((int)(v * 10 + 0.5) / 10.0);
	}

...
public class ComparisonOperator {
	...
	public static void main(String[] args) {
		...
		*/	
		...
		System.out.println(b); //결과가 참이
		
		b = 10 < 20 - 15; //산술연산 후 비교 연산을 수행한다
		System.out.println(b); //결과가 거짓이면 false
	
		b = 10 <= 10.0; // (double)10 <= 10.0 //이항연산자는 타입을 일치시킨 후 연산한다.
		System.out.println(b);
		
		b = 65 >= 'B'; //65 >= (int)'B'   //'B' = 66
		System.out.println(b);
		...
		System.out.println(b);
		b = !"abc".equals("ABC");
		System.out.println(b); //같지 않다의 결과를 얻기 위해서는 !(NOt)을 앞에 붙여준다.
		//System.out.println(); 자동완성 : Sysout + ctrl + space

...
import java.util.Scanner; //import는 다른 패키지에 있는 클래스의 위치를 알려준다.

public class SampleClass {	 //클래스명은 앞글자를 대문자로 한다.
	...
	*/
	...
	void test2(){
		System.out.println("3.test2시작");
		System.out.println("4.test2 종료");
	}
	
	void test3(){
		System.out.println("2.test3시작");
		test2();
